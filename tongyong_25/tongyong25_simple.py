...
LOCATION = {  
    ...
    "gotopeople0":[[2.8195689000433033,-2.2413569233334294,0.138],[0.0,0.0,0.8053245892457833,0.5928341302220295]],
    "findpeople1":[[2.73942594175554,-2.310976992660554,0.138],[0.0,0.0,0.9883815452998383,0.15199316073660543]],
    "gotopeople1":[[2.8195689000433033,-2.2413569233334294,0.138],[0.0,0.0,0.8053245892457833,0.5928341302220295]],
    "findpeople2":[[3.5480701906667624,-2.559736959690771,0.138],[0.0,0.0,-0.22544511927386016,0.9742558689561972]],
    "gotopeople2":[[2.8195689000433033,-2.2413569233334294,0.138],[0.0,0.0,0.8053245892457833,0.5928341302220295]],
    "findpeople3":[[3.545855374399566,-2.6734852021311695,0.138],[0.0,0.0,-0.6114889329377067,0.7912529841300473]],
    "gotopeople3":[[2.8195689000433033,-2.2413569233334294,0.138],[0.0,0.0,0.8053245892457833,0.5928341302220295]],
    ...
    def control(self):
        ...
        for i in range(4):
            ...
            if has_person is not False and faceresult == 0:
                self.navigator.goto("gotopeople"+str(i))
                self.fdseat.xuanzhuan("gotopeople"+str(i))
